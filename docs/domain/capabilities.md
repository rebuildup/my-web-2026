...
| identity | Public professional identity | **observed legacy / not implemented** | public handle・role・self narrative の一貫性。private fact を混ぜない | self-narrative / identity-data authority | continuous | 旧サイトに real/handle profile。shared entity 化は未観測 |
