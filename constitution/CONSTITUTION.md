# my-web-2026 Constitution

この文書は、my-web-2026 の開発組織における最上位 contract です。
...
my-web-2026 の開発組織の目的は current procedure への服従ではありません。
...
`rebuildup/project-init@release-0-3-0` (commit `57fb4a2e5abe6f52e4fd9cb2cb88234496e47d4b`) から project-local に reconcile した。具体的な Practice の差分は Operating Model / ADR に残し、この Constitution の guarantee は維持する。
